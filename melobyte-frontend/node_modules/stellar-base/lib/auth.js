...
function authorizeInvocationCallback(_x, _x2, _x3, _x4, _x5) {
  return _authorizeInvocationCallback.apply(this, arguments);
}
/**
 ...
 */
function _authorizeInvocationCallback() {
  _authorizeInvocationCallback = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(publicKey, signingMethod, networkPassphrase, validUntil, invocation) {
...
function buildAuthEntry(envelope, signature, publicKey) {
  ...
  return new _xdr["default"].SorobanAuthorizationEntry({
    ...
    credentials: _xdr["default"].SorobanCredentials.sorobanCredentialsAddress(new _xdr["default"].SorobanAddressCredentials({
      ...
      signatureArgs: [(0, _scval.nativeToScVal)({
