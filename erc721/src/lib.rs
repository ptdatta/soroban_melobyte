...
// Metadata hash from IPFS
// let mut metadata_json: Option<String> = None;
// // Implementation of the ERC721 functionalities for the contract
// pub fn set_metadata(&mut self, env: Env, json_content: String) {
//     let admin = get_admin(&env);
//     admin.require_auth();
//     self.metadata_json = Some(json_content);
// }

// pub fn get_metadata(&self, env: Env) -> Option<String> {
...
impl ERC721 for ERC721Contract {
    // Balance of the NFT for a spesific user
    ...
    // Approve an account to manage an NFT on behalf of its owner
    fn approve(
        env: Env,
        caller: Address,
    ...
    // Set or remove approval for an account
    ...
    // Get the address of the approved account
